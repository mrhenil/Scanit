...
import com.henil.scanit.BuildConfig;
import com.henil.scanit.R;
import com.henil.scanit.MainActivity;
import com.henil.scanit.TOSActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_share:
                ...
                intentShare.putExtra(Intent.EXTRA_TEXT, mContext.getString(R.string.share_text) + "http://github.com/mrhenil");
            ...
            case R.id.btn_rate_us:
                ...
                intentRateUs.setData(Uri.parse("http://github.com/mrhenil"));
            ...
            case R.id.btn_more_app:
                Uri uri = Uri.parse("https://github.com/mrhenil");
                Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
                try {
                    mContext.startActivity(goToMarket);
                } catch (ActivityNotFoundException e) {
                    mContext.startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("http://github.com/mrhenil")));
                }
                break;
    ...
    private void aboutMyApp() {
        ...
        MaterialDialog.Builder bulder = new MaterialDialog.Builder(mContext)
                ...
                .onPositive((dialog, which) -> {
                    Uri uri = Uri.parse("http://github.com/mrhenil");
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
                    try {
                        mContext.startActivity(goToMarket);
                    } catch (ActivityNotFoundException e) {
